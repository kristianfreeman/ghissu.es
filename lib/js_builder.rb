class JSBuilder
  ...
  def output
    @out = <<EOF
document.write("<link rel='stylesheet' type='text/css' href='https://issues-embed.herokuapp.com/assets/from_gh.css'>");
document.write("<link rel='stylesheet' type='text/css' href='https://issues-embed.herokuapp.com/assets/embed.css'>");
