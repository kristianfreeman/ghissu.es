class JSBuilder
  ...
  def output
    @out = <<EOF
document.write("<link rel='stylesheet' type='text/css' href='http://www.ghissu.es/assets/from_gh.css'>");
document.write("<link rel='stylesheet' type='text/css' href='http://www.ghissu.es/assets/embed.css'>");
